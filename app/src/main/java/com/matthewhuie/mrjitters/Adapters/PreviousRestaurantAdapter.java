...
public class PreviousRestaurantAdapter extends RecyclerView.Adapter<PreviousRestaurantAdapter.BookmarkViewHolder>{

    private List<Restaurant> restaurantSourceList;

    public PreviousRestaurantAdapter(List<Restaurant> restaurantSourceList){
